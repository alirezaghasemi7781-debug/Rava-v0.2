  ...
  return (
    <ModalShell open={true} onClose={onClose} contentClassName="max-w-lg">
      <ModalCard className="flex max-h-[85vh] flex-col">
        ...
        <div className="flex-1 overflow-y-auto border-s border-white/5 ps-8 no-scrollbar">
          {pastEvents.length === 0 ? (
            ...
            <div className="space-y-12 pb-10">
              {pastEvents.map((event) => (
                <div key={event.id} className="relative">
                  <div className="absolute -start-[41px] top-1 z-10 h-4 w-4 rounded-full border-4 border-rava-bg bg-blue-500/20" />
        ...
        <div className="mt-6 shrink-0 rounded-rava-xl border border-blue-500/10 bg-blue-500/5 p-6">
          <p className="text-rava-xs font-bold italic leading-relaxed text-white/40">
